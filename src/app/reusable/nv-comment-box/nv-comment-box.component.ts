...
@Component({
  selector: 'app-nv-comment-box',
  templateUrl: './nv-comment-box.component.html',
  styleUrls: ['./nv-comment-box.component.scss']
})
export class NVCommentBoxComponent implements OnInit {
  @Input()
