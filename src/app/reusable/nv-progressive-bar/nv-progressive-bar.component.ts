...
@Component({
  selector: 'app-nv-progressive-bar',
  templateUrl: './nv-progressive-bar.component.html',
  styleUrls: ['./nv-progressive-bar.component.scss']
})
export class NVProgressiveBarComponent implements OnInit {
